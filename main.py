...
player_bullet_fx = pygame.mixer.Sound('Sounds/Aeroblasters_Sounds_gunshot.wav')
click_fx = pygame.mixer.Sound('Sounds/Aeroblasters_Sounds_click.mp3')
collision_fx = pygame.mixer.Sound('Sounds/Aeroblasters_Sounds_mini_exp.mp3')
blast_fx = pygame.mixer.Sound('Sounds/Aeroblasters_Sounds_blast.wav')
fuel_fx = pygame.mixer.Sound('Sounds/Aeroblasters_Sounds_fuel.wav')

pygame.mixer.music.load('Sounds/Aeroblasters_Sounds_Defrini - Spookie.mp3')
...
enemy_bulet_group = pygame.sprite.Group()
...
while running:
    ...
    if game_page:
        ...
        enemy_bulet_group.update()
        enemy_bulet_group.draw(win)
        ...
        enemy_group.update(enemy_bulet_group, explosion_group)
        enemy_group.draw(win)

        if p.alive:
            player_hit = pygame.sprite.spritecollide(p, enemy_bulet_group, False)
